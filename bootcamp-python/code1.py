...
# variables are simple containers that store data of different types

# data types
favouriteNumber = 2 # integer (int)
numberFloat = 2.1 # float 
name = 'Kyle' # string (str)
doesHePlayRoblox = True # boolean (bool) - true/false
favouriteFruits = ["pawpaw", "apple", "grapes"] # list
